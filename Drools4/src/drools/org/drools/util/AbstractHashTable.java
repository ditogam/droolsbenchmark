...
import com.drools.perf.test.helper.Measurements;
...
public abstract class AbstractHashTable
    implements
    Serializable {
    public static final Measurements MEASUREMENTS = new Measurements(50);
...
//        measureSize();
    ...
    public void initTable(int capacity) {
