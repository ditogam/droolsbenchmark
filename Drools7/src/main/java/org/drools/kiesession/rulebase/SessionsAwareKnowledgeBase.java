...
//
//    private final transient Map<Long, InternalWorkingMemory> statefulSessions = new ConcurrentHashMap<>();
//
...
//        return (Collection<? extends KieSession>) (Object) List.copyOf(statefulSessions.values());
//    }
//
//    @Override
...
//        this.statefulSessions.put(wm.getIdentifier(), wm);
//    }
//
//    @Override
//    public void disposeStatefulSession(InternalWorkingMemory statefulSession) {
//        this.statefulSessions.remove(statefulSession.getIdentifier());
...
//        return List.copyOf(statefulSessions.values());
//    }
//
//    @Override
...
//        }
//
//        delegate.kBaseInternal_addPackages(clonedPkgs, statefulSessions.values());
//
//        for (InternalKnowledgePackage newPkg : clonedPkgs) {
//            for (Rule rule : newPkg.getRules()) {
...
//            delegate.kBaseInternal_removePackage(pkg, statefulSessions.values());
...
//            }
//            delegate.kBaseInternal_addRules(rules, statefulSessions.values());
//            for (RuleImpl rule : rules) {
...
//            delegate.kBaseInternal_removeRule(pkg, rule, statefulSessions.values());
...
//                this.eventSupport.fireBeforeRuleRemoved(rule);
//            }
//            delegate.kBaseInternal_removeRules(rules, statefulSessions.values());
//            for (RuleImpl rule : rules) {
//                this.eventSupport.fireAfterRuleRemoved(rule);
//            }
//        });
